...
## C++ low-latency capture scaffold

This repo also includes a C++20 scaffold for saving Angel One SmartAPI WebSocket 2.0 Snap Quote binary frames with nanosecond-resolution local timestamps, compact binary storage, and mmap SPSC IPC for a strategy process. See `docs/ANGEL_SMARTAPI_CAPTURE.md` for the SmartAPI interpretation, daily storage layout, stop-at-15:31 IST behavior, and build commands.
